package lia2.part1.analyzers;

import static org.junit.jupiter.api.Assertions.assertEquals;

import lia2.part1.analyzers.metaphone.MetaphoneReplacementAnalyzer;
import lia2.part1.analyzers.metaphone.MetaphoneReplacementFilter;
import lia2.part1.analyzers.synonym.SynonymAnalyzer;
import lia2.part1.analyzers.synonym.SynonymAnalyzer.TestSynonymEngine;
...
public class AnalyzerTest extends AbstractQueryTest {
  ...
  public void jumpsTest() throws Exception {
    ...
    while (stream.incrementToken()) {
      String token = new String(term.buffer(), 0, term.length());
  ...
  public void termQueryTest() throws Exception {
    // Tear down and re-setup because there's some test writing extra documents into the index
    teardown();
    setup();
